...
public class service_Coupon_Use {

	private StringBuffer sb;
	private String result = "";
	public Activity act = null;

	public service_Coupon_Use(Activity act, String username, String couponID) {
		this.act = act;
		try {
			sb = new StringBuffer();
			sb.append(act.getResources().getString(R.string.service_Coupon_Use));
			...
			Log.e("use coupon countdown", sb.toString());
