...
public class service_QRCoupon_Transfer {
	...
	public service_QRCoupon_Transfer(Activity act, String username, String password, String couponID, String r_username, String email, String r_email ) {
		this.act = act;

		try {
			sb = new StringBuffer();
			sb.append(act.getResources().getString(R.string.service_QRCoupon_Transfer));
