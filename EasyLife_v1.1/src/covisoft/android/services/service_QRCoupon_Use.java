...
public class service_QRCoupon_Use {
	...
	public service_QRCoupon_Use(String username, String couponID, Activity act) {
		this.act = act;
		try 
		{
			sb = new StringBuffer();
			sb.append(act.getResources().getString(R.string.service_QRCoupon_Use));
			...
			Log.e("Use QRCoupon: username = " + username + " - couponID = " + couponID, sb.toString());
		} 
