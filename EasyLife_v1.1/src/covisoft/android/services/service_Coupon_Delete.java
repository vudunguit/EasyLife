...
public class service_Coupon_Delete {

	private StringBuffer sb;
	private String result = "";
	public Activity act = null;

	public service_Coupon_Delete() {
	}

	public void init(String no, Activity act) {
		this.act = act;
		try {
			sb = new StringBuffer();
			sb.append(act.getResources().getString(R.string.service_delete_coupon));
			sb.append("no").append("=").append(URLEncoder.encode(no, "UTF-8")).append("&");
			sb.append("delYn").append("=").append(URLEncoder.encode("Y", "UTF-8"));
			
			Log.e("delete coupon", sb.toString());
