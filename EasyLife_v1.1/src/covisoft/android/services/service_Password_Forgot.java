...
public class service_Password_Forgot {

	StringBuffer sb;
	String result = "";
	public Activity act = null;

	public service_Password_Forgot(Activity act, String email) {
		this.act = act;
		try {
			sb = new StringBuffer();
			sb.append(act.getResources().getString(R.string.service_forgotPassword));
			sb.append("email").append("=").append(URLEncoder.encode(email, "UTF-8"));
			
			Log.e("Frogot Password", sb.toString());
