...
/*
 * Adapter shop list shop in tab 3
 * 
 * Last Updater: Huan
 ...
 *        - Change inflater to local variable
 * 
 */
public class Adapter_Shop extends BaseAdapter {

	private final ArrayList<item_store_list> values;

	private NavigationActivity activity;

	private ImageLoader_Rounded imageLoader;
	private String categoryName = "";
	private String parentCategoryNo = "1";
...
// =========================================================================================
	public Adapter_Shop(NavigationActivity activity, ArrayList<item_store_list> arItem, int type, String categoryName, String parentCaetgoryNo) {
		this.values = arItem;
		this.activity = activity;
		this.type = type;
		this.categoryName = categoryName;
		this.parentCategoryNo = parentCaetgoryNo;
	...
	public item_store_list getItem(int position) {
