...
package covisoft.android.AR.data;
...
//				break;
			case EZLIFE:
//				ret += "?category=" + 1 + "&latitude" + GPS_location.latitude + "&longitude" + GPS_location.longitude;
				ret += "?category=" + 1 + "&latitude" + Home_Activity.latitude + "&longitude" + Home_Activity.longitude;
				break;
			}
...
//			break;
	...
	public boolean isWellFormed() {
		boolean out = false;
		if (isUrlWellFormed() || getName() != null || !getName().equals("")) {
			out = true;
		}
		return out;
	}
