...
public class Activity_Login_Tab5 extends NavigationActivity {
...
// ===================================================================================================
	...
	protected void onResume() {
		...
		if (EasyLifeActivity.user != null) {
			Intent intent = new Intent(Activity_Login_Tab5.this, Activity_MyProfile_Tab5.class);
	...
	private class AsyncTaskRequestData extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			service_Login xml = new service_Login(Activity_Login_Tab5.this, username, password);
			...
			if (result.equals("2")) {
				...
				t.schedule(new TimerTask() {
					...
					public void run() {
						...
						activity.runOnUiThread(new Runnable() {
							public void run() {
								showPopupOneOption(Activity_Login_Tab5.this.getResources().getString(R.string.popup_LoginFail_cannotConnect), 1);
							}
						});
					}
				}, 300);
				...
				t.schedule(new TimerTask() {
					...
					public void run() {
						...
						activity.runOnUiThread(new Runnable() {
							public void run() {
								showPopupOneOption(Activity_Login_Tab5.this.getResources().getString(R.string.popup_LoginFail), 1);
							}
						});
					}
				}, 300);
				...
				t.schedule(new TimerTask() {
					...
					public void run() {
						...
						activity.runOnUiThread(new Runnable() {
							public void run() {
								showPopupOneOption(Activity_Login_Tab5.this.getResources().getString(R.string.popup_cannot_conect), 1);
							}
						});
					}
				}, 300);
	...
	void initBtnRegister() {
		...
		btnRegister.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(Activity_Login_Tab5.this, Activity_Register.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
	...
	public void initBtnForgotPass() {
		...
		btnForgot.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(Activity_Login_Tab5.this, Activity_ForgotPass_Tab5.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		if (!EZUtil.isLoading) {
			...
			dialog.setOnDismissListener(new OnDismissListener() {
				...
				public void onDismiss(DialogInterface dialog) {
					...
					if (fiType == 2) {
						if(from.equals("Activity_More")) {
							Intent intent = new Intent(Activity_Login_Tab5.this, Activity_NotifyList.class);
							intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
							goNextHistory_2("Activity_NotifyList", intent);
						} else {
							Intent intent = new Intent(Activity_Login_Tab5.this, Activity_MyProfile_Tab5.class);
							intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
							goNextHistory_2("Activity_MyProfile_Tab5", intent);
			...
			btnFBLogin.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (!Utility.mFacebook.isSessionValid()) {
						Toast.makeText(Activity_Login_Tab5.this, "Authorizing", Toast.LENGTH_SHORT).show();
						Utility.mFacebook.authorize(Activity_Login_Tab5.this.getParent(), permission, new LoginDialogListener());
					} else {
						activity.runOnUiThread(new Runnable() {
							public void run() {
								if (getParent() != null) {
						...
						try {
							...
							SessionStore.save(Utility.mFacebook, Activity_Login_Tab5.this);
	...
	public final class LoginDialogListener implements DialogListener {
		...
		public void onFacebookError(FacebookError error) {
			btnFBLogin.setVisibility(View.VISIBLE);
			Toast.makeText(Activity_Login_Tab5.this, "Something went wrong. Please try again.", Toast.LENGTH_LONG).show();
		}
    ...
    private class AsyncTask_LoginFB extends AsyncTask<Void, Void, item_FBLogin> {
		...
		protected item_FBLogin doInBackground(Void... params) {
			...
			service_Login_FB xml = new service_Login_FB(Activity_Login_Tab5.this, fbEmail, fbUsername, fbFname, fbGender, fbImg);
			...
			if (result.getResult().equals("1")) {
				...
				t.schedule(new TimerTask() {
					...
					public void run() {
						...
						activity.runOnUiThread(new Runnable() {
							public void run() {
								showPopupOneOption(Activity_Login_Tab5.this.getResources().getString(R.string.popup_LoginFB_ProblemConnect), 1);
							}
						});
					}
				}, 300);
				...
				t.schedule(new TimerTask() {
					...
					public void run() {
						...
						activity.runOnUiThread(new Runnable() {
							public void run() {
								showPopupOneOption(Activity_Login_Tab5.this.getResources().getString(R.string.popup_LoginFB_New), 2);
							}
						});
					}
				}, 300);
