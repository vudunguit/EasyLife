...
/*
 * Activity show list of Franchise (not list Franchise's shops)
 * 
 ...
 * 
 */
public class Activity_FranchiseList extends NavigationActivity {
...
// ===================================================================================================================
	...
	private class AsyncTaskRequestData extends AsyncTask<Void, Void, ArrayList<item_Franchise>> {
		...
		protected ArrayList<item_Franchise> doInBackground(Void... params) {
			...
			service_Franchise xml = new service_Franchise(Activity_FranchiseList.this, category_Code);
	...
	void init_listview(ArrayList<item_Franchise> arItem) {
		...
		Adapter_Franchise_Home MyAdapter = new Adapter_Franchise_Home(Activity_FranchiseList.this, arItem);
