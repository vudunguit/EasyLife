...
public class Activity_Map_All_Shop extends NavigationMapActivity {

	public static Activity activity = null;
	public static NavigationMapActivity navi;
	public static String category = "";
	public static String categoryName = "";
	public static String parentCategoryNo = "";

	public static MyItemizedOverlay itemizedOverlay;
	public static ArrayList<item_store_list> arItem;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Serializable intent_item = intent.getSerializableExtra("ItemStore");

		category = intent.getStringExtra("category");
		categoryName = intent.getStringExtra("categoryName");
		parentCategoryNo = intent.getStringExtra("parentCategoryNo");

		arItem = (ArrayList<item_store_list>) intent_item;
	...
	void init_Btn_AR() {
		...
		btnAR.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(Activity_Map_All_Shop.this, MixView.class);
	...
	void init_itemizeoverlay_me(List<Overlay> mapOverlays, TapControlledMapView mapView) {
		...
		// GeoPoint point = getPoint(GPS_location.latitude,
	...
	void init_itemizeoverlay(List<Overlay> mapOverlays, TapControlledMapView mapView) {
		...
		Activity_HireEmployee.xml = null;
		...
		for (int i = 0; i < len; i++) {
			double latitude = Double.valueOf(f_convert(arItem.get(i).lat)).doubleValue();
			double longitude = Double.valueOf(f_convert(arItem.get(i).lng)).doubleValue();
			f_add_overlayItem(itemizedOverlay, latitude, longitude, arItem.get(i).name, null);
		}
