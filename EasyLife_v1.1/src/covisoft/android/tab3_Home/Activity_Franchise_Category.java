...
/*
 * Activity use to show list of Category: Home_Activity -> Franchise
 * 
 *  Created: 15/07/2013
 *  Creater: Huan
 */
public class Activity_Franchise_Category extends NavigationActivity {
...
// ===================================================================================================================
	...
	private void init_ListCategory() {
		...
		adapter = new Adapter_Franchise_Group(Activity_Franchise_Category.this, arrCategory);
		...
		listCategory.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				Intent intent = new Intent(Activity_Franchise_Category.this, Activity_Franchise.class);
