...
public class item_store_list implements Serializable {
	public item_store_list(String no, int coupon, String name, String addr,
	...
	public static class NameComparator implements Comparator<Object> {
		public int compare(Object o1, Object o2) {
			String en1 = ((item_store_list) o1).name;
			String en2 = ((item_store_list) o2).name;
	...
	public static class DistanceComparator implements Comparator<Object> {
		public int compare(Object o1, Object o2) {
			...
			double en1 = ((item_store_list) o1).distance;
			double en2 = ((item_store_list) o2).distance;
	...
	public static class LevelComparator implements Comparator<Object> {
		public int compare(Object o1, Object o2) {
			...
			int lev1 = ((item_store_list) o1).level;
			int lev2 = ((item_store_list) o2).level;
