...
public class UpdateStatusResultDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(covisoft.android.EasyLife.R.layout.update_post_response);
        LayoutParams params = getWindow().getAttributes();
        params.width = LayoutParams.FILL_PARENT;
        params.height = LayoutParams.FILL_PARENT;
        getWindow().setAttributes((android.view.WindowManager.LayoutParams) params);

        mOutput = (TextView) findViewById(covisoft.android.EasyLife.R.id.apiOutput);
        mOutput.setText(values.toString());

        mUsefulTip = (TextView) findViewById(covisoft.android.EasyLife.R.id.usefulTip);
        mUsefulTip.setMovementMethod(LinkMovementMethod.getInstance());
        mViewPostButton = (Button) findViewById(covisoft.android.EasyLife.R.id.view_post_button);
        mDeletePostButton = (Button) findViewById(covisoft.android.EasyLife.R.id.delete_post_button);
    ...
    public class WallPostRequestListener extends BaseRequestListener {
        ...
        public void onComplete(final String response, final Object state) {
            try {
                ...
                setText(activity.getString(covisoft.android.EasyLife.R.string.exception) + e.getMessage());
            }
        }

        public void onFacebookError(FacebookError error) {
            setText(activity.getString(covisoft.android.EasyLife.R.string.facebook_error) + error.getMessage());
        }
    }
